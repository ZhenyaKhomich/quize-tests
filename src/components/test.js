...
export class Test {
    ...
    showQuestion() {
        ...
        const that = this;
        const chosenOption = this.userResult.find(elem =>
            elem.questionId === activeQuestion.id
        )
        ...
        if (chosenOption && chosenOption.chosenAnswerId) {
            ...
            this.passButtonElement.classList.add('inactive');
        } else {
            this.nextButtonElement.setAttribute('disabled', 'true');
            this.passButtonElement.classList.remove('inactive');
        }
